...
export default function MainScreen() {
  ...
  /**
   * ============================
   * FORMATA HORÁRIO DE ATUALIZAÇÃO
   * ============================
   */
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      {/* TÍTULO */}
      <Text style={styles.headerTitle}>Explorando a Geo-Localização</Text>
      ...
      <InfoCard title="Endereço (Aproximado)" icon="home" color="#D97706">
        {address ? (
          ...
          <Text style={styles.addressText}>Endereço não encontrado</Text>
        )}
      </InfoCard>

      {/* ============================
          ATUALIZADO (FORA DOS CARDS)
         ============================ */}
      {lastUpdated && (
